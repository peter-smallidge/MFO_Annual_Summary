...
read01_numeric <- read_excel("visit_request_raw_sept_oct_2023.xlsx", skip=2, col_names = F)
read01_numeric = read01_numeric[-1,]

read02_numeric <- read_excel("visit_request_raw_sept_oct_2023.xlsx", n_max = 1) %>% 
  clean_names() 
...
request_data$property_addr <- tolower(request_data$property_addr)
...
write_csv(request2023_vartype, "requested_raw_sept_oct2023.csv")
